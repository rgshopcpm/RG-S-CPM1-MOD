...
from RGSCPM1MOD import RGSCPM1MOD

__CHANNEL_USERNAME__ = "@rg01111"
__GROUP_USERNAME__   = "@rg01111"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - https://t.me/rgcpm1mod"
    colors = [
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with RGSCPM1MOD.'))
